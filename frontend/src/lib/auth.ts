...
export const SUPER_ADMIN_EMAIL = "admin@elijays.co.ke";
...
const TOKEN_KEY = "elijays_pos_token";
const USER_KEY = "elijays_pos_user";
const SESSION_COOKIE = "elijays_pos_session";
...
export const BRAND = {
  name: "Elijay's Men's Wear",
  phone: "0721844475",
  email: "info@elijays.co.ke",
  web: "https://elijays.co.ke",
};
